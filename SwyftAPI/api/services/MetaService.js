module.exports = {
  ...
  getOrderMetadata: function (recordsPerPage, filters, cb) {
    ...
    var combined = [{
      ...
      enum: [{
        ...
        propertyName: 'swyftdebit',
        displayName: 'Swyft Debit'
      }, {
        propertyName: 'cash',
        displayName: 'Cash'
      }, {
        propertyName: 'cash+swyftdebit',
        displayName: 'Cash + Swyft Debit'
      }],
      editable: true
    }, {
  ...
  getDeliveryGroupMetadata: function (recordsPerPage, filters, cb) {
    var self = this;
    var combined = [{
      propertyName: 'id',
      displayName: 'ID',
    ...
    DeliveryGroup.find(this.processFilters(filters)).exec(function (err, data) {
      cb({
        total: data.length,
        totalPages: Math.ceil(data.length / recordsPerPage),
        sort: 'createdAt',
  ...
  getAttachedRequestMetadata: function (recordsPerPage, filters, cb) {
    var self = this;
    var combined = [{
      propertyName: 'id',
      displayName: 'ID',
    ...
    AttachedRequest.find(this.processFilters(filters)).exec(function (err, data) {
      cb({
        total: data.length,
        totalPages: Math.ceil(data.length / recordsPerPage),
        sort: 'createdAt',
