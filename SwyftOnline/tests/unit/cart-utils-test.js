...
describe("cartUtils#getCartForRestore", function() {
    it("should return cart when array exists in cart", function(done) {
        localStorage.clear();
    ...
    it("should return when array exists in cart, even if not formatted as a cart", function(done) {
        localStorage.clear();
    ...
    it("should return array when cart is invalid, string", function(done) {
        localStorage.clear();
        var object = 'invalid';
        localStorage.setItem("cart", JSON.stringify(object));
    ...
    it("should return empty array when cart is invalid, number", function(done) {
        localStorage.clear();
        var object = 12;
        localStorage.setItem("cart", JSON.stringify(object));
        assert.deepEqual(cartUtils.getCartForRestore(), []);
    ...
    it("should return empty array when cart is invalid, boolean", function(done) {
        localStorage.clear();
        var object = true;
        localStorage.setItem("cart", JSON.stringify(object));
        assert.deepEqual(cartUtils.getCartForRestore(), []);
    ...
    it("should return empty array when cart is invalid, object", function(done) {
        localStorage.clear();
    ...
    it("should return empty array when cart doesn't exist", function(done) {
        localStorage.clear();
        assert.deepEqual(cartUtils.getCartForRestore(), []);
        done();
    });    
