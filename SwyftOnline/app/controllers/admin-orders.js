...
export default Ember.Controller.extend(AdminPageMixin, {
    modelName: 'Order',
    description: 'Add, update, and edit Orders.',
    ...
    actions: {
        delete: function(id) {
            ...
            this.set('dialogBody', "You are attempting to permanently delete this order.");
        ...
        accept: function() {
            ...
            if(this.get('deleteId')) {
                Ember.$.ajax({
                    url: config.routeLocation + "/api/admin/order/" + this.get('deleteId'),
                    data: {
                    ...
                    success: function(response) {
                        ...
                        self.set('modalTitle', 'Order Deleted');
                        self.set('modalBody', 'This order has been successfully deleted.');
        ...
        goToNewDeliveryLocation: function() {
            this.transitionToRoute('admin-order', 0);
        },
        goToDeliveryLocation: function(id) {
            this.transitionToRoute('admin-order', id);
        }
    }
});